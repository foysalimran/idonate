...
if ( ! class_exists( 'IDONATE_Field_textarea' ) ) {
	class IDONATE_Field_textarea extends IDONATE_Fields {
		...
		public function shortcoder() {
			...
			if ( ! empty( $this->field['shortcoder'] ) ) {
				...
				$instances  = ( ! empty( IDONATE::$shortcode_instances ) ) ? IDONATE::$shortcode_instances : array();
					...
					foreach ( $shortcodes as $shortcode ) {
						...
						foreach ( $instances as $instance ) {
							...
							if ( $instance['modal_id'] === $shortcode ) {
								...
								echo '<a href="#" class="button button-primary idonate-shortcode-button" data-modal-id="' . esc_attr( $id ) . '">' . esc_html( $title ) . '</a>';
