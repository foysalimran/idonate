...
(function($) {
  ...
  function IDONATEAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  IDONATEAjaxChosen.prototype.init = function() {
  ...
  IDONATEAjaxChosen.prototype.events = function() {
  ...
  IDONATEAjaxChosen.prototype.search_field_focused = function() {
  ...
  IDONATEAjaxChosen.prototype.search_welcome_message = function() {
  ...
  IDONATEAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('idonate-chosen', _this.options.data).done( function( response ) {
  ...
  IDONATEAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.idonate-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.IDONATEChosenOrder($hidden_value, true);
  ...
  $.fn.IDONATEAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new IDONATEAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, IDONATEAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  IDONATEAbstractChosenOrder = (function() {

    function IDONATEAbstractChosenOrder() {}

    IDONATEAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    IDONATEAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    IDONATEAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    IDONATEAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    IDONATEAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    IDONATEAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    IDONATEAbstractChosenOrder.IDONATEChosenOrder = function(select, order, force) {
    ...
    return IDONATEAbstractChosenOrder;
  ...
  $.fn.extend({
    IDONATEChosenOrder: function(order, force) {
      return _IDONATEChosenOrder.IDONATEChosenOrder(this, order, force);
    }
  });

  this._IDONATEChosenOrder = (function(_super) {
    __extends(_IDONATEChosenOrder, _super);

    function _IDONATEChosenOrder() {
      _ref = _IDONATEChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _IDONATEChosenOrder.relAttributeName = 'data-option-array-index';

    _IDONATEChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _IDONATEChosenOrder.getDOMElement = function(element) {
    ...
    _IDONATEChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _IDONATEChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _IDONATEChosenOrder;

  })(IDONATEAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('idonate-depend-on');
        });
        ...
        $(controls).each(function() {
          $(this).addClass('idonate-depend-on');
        });
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectIDONATE = FormSerializer.serializeObject;
    $.fn.serializeJSONIDONATE   = FormSerializer.serializeJSON;
  }
