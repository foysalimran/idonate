...
namespace ThemeAtelier\Idonate\Helpers\Countries;
...
{
	//  All countries
	public static function idonate_all_countries()
	{
		return array(
	...
	public static function idonate_country_name_by_code($code = '')
	{
		$cnty = self::IDONATE_COUNTRIES();
