 ...
 * @version 1.0.0
 */
if ( ! class_exists( 'IDONATE_Field_color' ) ) {
	class IDONATE_Field_color extends IDONATE_Fields {
		...
		public function render() {
			...
			echo '<input type="text" name="' . esc_attr( $this->field_name() ) . '" value="' . esc_attr( $this->value ) . '" class="idonate-color"' . wp_kses_post($default_attr) . wp_kses_post( $this->field_attributes() ) . '/>';
