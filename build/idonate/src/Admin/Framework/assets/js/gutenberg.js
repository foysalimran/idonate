...
( function( blocks, blockEditor, element, components ) {
  ...
  if ( !window.idonate_gutenberg_blocks ) { return; }

  Object.values(window.idonate_gutenberg_blocks).forEach( function( block ) {
    ...
    registerBlockType(block.name, {
      ...
      edit: function (props) {
        return (
          createElement('div', {className: 'idonate-shortcode-block'},

            createElement(Button, {
              'data-modal-id': block.modal_id,
              'data-gutenberg-id': block.name,
              className: 'is-secondary idonate-shortcode-button',
              onClick: function () {
                window.idonate_gutenberg_props = props;
              },
            }, block.button_title ),
