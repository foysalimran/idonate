...
?>
		<div class="idonate blood-request-widget">
			<?php
			$postargs = array(
	...
	?>
		...
		<p>
			...
			<input class="widefat" id="<?php echo esc_attr($this->get_field_id('requestnumber')); ?>" name="<?php echo esc_attr($this->get_field_name('requestnumber')); ?>" type="text" value="<?php echo esc_attr($requestnumber); ?>" />
		</p>
...
<?php
	...
	public function update($new_instance, $old_instance)
	{
		...
		$instance['requestnumber']  = (!empty($new_instance['requestnumber'])) ? wp_strip_all_tags($new_instance['requestnumber']) : '';
