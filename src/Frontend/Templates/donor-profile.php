...
?>
<div class="idonate donor_profile section-padding">
	<div class="ta-container">
		<div class="ta-row">
			<div class="ta-col-xs-1 ta-col-sm-1 ta-col-md-1 ta-col-lg-3 ta-col-xl-3">
				<div class="donor_profile_menu">
					<ul>
						<li><a href="<?php echo esc_html(idonatefile_edit_permalink()); ?>"><?php esc_html_e('Edit Profile', 'idonate'); ?></a></li>
			...
			<div class="ta-col-xs-1 ta-col-sm-1 ta-col-md-1 ta-col-lg-2-3 ta-col-xl-2-3">
				<div class="donor-profile">
					...
					<div class="donor-img">
						<?php
						echo wp_kses_post(idonatefile_img($userID));
						?>
					</div>
					<div class="personal-info text-center">
						<h3><?php echo esc_html(get_user_meta($userID, 'idonate_donor_full_name', true)); ?></h3>
						<p><?php echo esc_html(esc_html($userData->user_email)); ?></p>
						<p><?php echo esc_html(get_user_meta($userID, 'idonate_donor_mobile', true)); ?></p>
						<p><?php echo esc_html(get_user_meta($userID, 'idonate_donor_availability', true)); ?></p>
						<p><?php echo esc_html(get_user_meta($userID, 'idonate_donor_bloodgroup', true)); ?></p>
					</div>
