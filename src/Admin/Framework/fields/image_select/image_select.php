 ...
 * @version 1.0.0
 */
if ( ! class_exists( 'IDONATE_Field_image_select' ) ) {
	class IDONATE_Field_image_select extends IDONATE_Fields {
		...
		public function render() {
			...
			$inline = ( $args['inline'] ) ? ' idonate--inline-list' : '';
			...
			if ( ! empty( $args['options'] ) ) {
				...
				echo '<div class="idonate-siblings idonate--image-group' . esc_attr( $inline ) . '" data-multiple="' . esc_attr( $args['multiple'] ) . '">';
