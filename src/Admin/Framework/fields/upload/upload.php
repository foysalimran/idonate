 ...
 * @version 1.0.0
 */
if ( ! class_exists( 'IDONATE_Field_upload' ) ) {
	class IDONATE_Field_upload extends IDONATE_Fields {
		...
		public function render() {
			...
			if ( ! empty( $args['preview'] ) ) {
				...
				echo '<div class="idonate--preview' . esc_attr( $preview_hidden ) . '">';
			...
			echo '<a href="#" class="button button-primary idonate--button" data-library="' . esc_attr( $library ) . '">' . esc_html( $args['button_title'] ) . '</a>';
			echo '<a href="#" class="button button-secondary idonate-warning-primary idonate--remove' . esc_attr( $hidden ) . '">' . esc_html( $args['remove_title'] ) . '</a>';
			echo '</div>';
