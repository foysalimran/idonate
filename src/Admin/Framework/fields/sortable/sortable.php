...
if ( ! class_exists( 'IDONATE_Field_sortable' ) ) {
	class IDONATE_Field_sortable extends IDONATE_Fields {
		...
		public function render() {
			...
			echo '<div class="idonate-sortable" data-depend-id="' . esc_attr( $this->field['id'] ) . '">';
			...
			foreach ( $pre_sortby as $key => $field ) {
				...
				echo '<div class="idonate-sortable-item">';

				echo '<div class="idonate-sortable-content">';
				...
				IDONATE::field( $field, $field_value, $unique_id, 'field/sortable' );
