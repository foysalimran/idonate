...
if ( ! class_exists( 'IDONATE_Abstract' ) ) {
  abstract class IDONATE_Abstract {
    ...
    public function __construct() {
      ...
      if ( ! empty( $this->args['output_css'] ) || ! empty( $this->args['enqueue_webfont'] ) ) {
        ...
        IDONATE::$css = apply_filters( "idonate_{$this->unique}_output_css", IDONATE::$css, $this );
      }
    ...
    public function recursive_output_css( $fields = array(), $combine_field = array() ) {
      ...
      if ( ! empty( $fields ) ) {
        foreach ( $fields as $field ) {
          ...
          $field_class  = 'IDONATE_Field_' . $field_type;
