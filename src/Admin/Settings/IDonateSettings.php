				...
				'fields' => array(
					array(
						...
						'tabs' => array(
							...
							array(
								'title'  => __('Text Settings', 'idaonte-pro'),
								'fields' => array(
									array(
								...
								'fields' => array(
									...
									array(
										...
										'options' => array(
											...
											'two_week' => esc_html__('Delete Two Weeks After Blood Needed Date', 'idonate'),
											'one_month' => esc_html__('Delete One Month After Blood Needed Date', 'idonate'),
										),
										'default' => 'one_week',
									),
								),
