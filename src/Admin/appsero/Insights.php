...
class Insights {
    ...
    public function __construct( $client, $name = null, $file = null ) {
        ...
        if ( is_object( $client ) && is_a( $client, 'IdonateAppSero\Client' ) ) {
            $this->client = $client;
        }
    }
    ...
    public function admin_notice() {
        ...
        if ( empty( $this->notice ) ) {
            $notice = sprintf( $this->client->idonate_trans( 'Want to help make <strong>%1$s</strong> even more awesome? Allow %1$s to collect non-sensitive diagnostic data and usage information.' ), $this->client->name );
        } else {
            $notice = $this->notice;
        }
        ...
        $notice .= ' (<a class="' . $this->client->slug . '-insights-data-we-collect" href="#">' . $this->client->idonate_trans( 'what we collect' ) . '</a>)';
        ...
        echo '<div class="updated"><p>';
            ...
            echo '&nbsp;<a href="' . esc_url( $optin_url ) . '" class="button-primary button-large">' . $this->client->idonate_trans( 'Allow' ) . '</a>';
            echo '&nbsp;<a href="' . esc_url( $optout_url ) . '" class="button-secondary button-large">' . $this->client->idonate_trans( 'No thanks' ) . '</a>';
        echo '</p></div>';
    ...
    private function get_uninstall_reasons() {
        $reasons = array(
			...
			array(
				...
				'text'        => $this->client->idonate_trans( "Not what I was looking" ),
				'placeholder' => $this->client->idonate_trans( 'Could you tell us a bit more?' ),
			...
			array(
				...
				'text'        => $this->client->idonate_trans( "Didn't work as expected" ),
				'placeholder' => $this->client->idonate_trans( 'What did you expect?' ),
    ...
    <div class="wd-dr-modal-wrap">
        ...
        <div class="wd-dr-modal-body">
            ...
            <p class="wd-dr-modal-reasons-bottom">
                <?php
                       echo sprintf(
	                       $this->client->idonate_trans( 'We share your data with <a href="%1$s" target="_blank">Appsero</a> to troubleshoot problems &amp; make product improvements. <a href="%2$s" target="_blank">Learn more</a> about how Appsero handles your data.'),
