...
if (!class_exists('TaT_Donor')) {
	...
	class TaT_Donor
	{
		...
		{
			include_once(IDONATE_DIR_PATH . 'src/js-templates/modal-noform-popup.php');
		}

		public function donor_form_popup()
		{
			include_once(IDONATE_DIR_PATH . 'src/js-templates/modal-form-popup.php');
		}
		public function jstmpl_donor_profile_view()
		{
			idonate_get_js_template(IDONATE_DIR_PATH . 'src/js-templates/donor-profile-view.php', 'donor-view-template');
		}

		public function jstmpl_donor_profile_edit()
		{
			idonate_get_js_template(IDONATE_DIR_PATH . 'src/js-templates/donor-profile-edit.php', 'donot-edit-template');
		}

		public function jstmpl_donor_register()
		{
			idonate_get_js_template(IDONATE_DIR_PATH . 'src/js-templates/donor-profile-register.php', 'donor-register-template');
		}

		public function jstmpl_donor_profile_delete()
		{
			idonate_get_js_template(IDONATE_DIR_PATH . 'src/js-templates/donor-profile-delete.php', 'donor-delete-template');
		}
	}
}
